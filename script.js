        ...
        function encryptText() {
            ...
            let escapedInput = toHtmlEntity(input);

            let encrypted = [];
            for (let char of escapedInput) {
        ...
        function decodeFromImage(img) {
            ...
            document.getElementById("output").textContent = fromHtmlEntity(decrypted);
        }
